...
export default function MouBadge({ 
  ...
  return (
    <span 
      ...
      tabIndex={0}
      role="note"
      aria-label="Verified MoU Partner: This institution has a signed MoU with Kerala Startup Mission (KSUM), offering subsidized user fee rates to registered startups."
    >
      {variant === 'compact' ? (
        <span 
        ...
        >
          ...
          <span>MoU Partner · Subsidized Rates</span>
        </span>
      ) : (
        <span 
      ...
      {isTooltipOpen && (
        ...
        >
          <div className="flex items-center gap-1.5 font-semibold text-emerald-300 mb-1 border-b border-slate-800 pb-1">
            ...
            <span>KSUM MoU Verified Partner</span>
          </div>
